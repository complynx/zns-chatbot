...
autocrop-command = Мне подходит
select-position-command = Выбрать расположение
select-position-prompt = Фото загружено. Расположи фото как тебе больше нравится.
