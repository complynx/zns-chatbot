...
passes-added-to-waitlist =
    Привет, <i>{$name}</i>!
    К сожалению, все пассы на данный момент распроданы. Тем не менее, вы добавлены в список ожидания для пасса {$role ->
        [leader] партнёра
        *[follower] партнёрши
    } Zouk Non Stop.
...
passes-payment-proof-wrong-data =
    ...
    Чтобы попробовать снова, используйте команду /passes и отправьте правильный файл или изображение.
...
passes-legal-name-request-message =
    ...
    <i>Отправляя ваши данные, вы соглашаетесь на их хранение, обработку и использование в соответствии с нашей политикой конфиденциальности.</i>
