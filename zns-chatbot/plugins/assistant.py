...
Так как Лисоборье на территории режимного объекта, для входа обязателен оригинал паспорта или пропуск. Пропуск иностранцам оформляется по фото загранпаспорта не менее чем за неделю до мероприятия через телеграм @liubka_z
